...
const VerticalCart = ({loading,data=[] }) => {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(270px,300px))] justify-center md:justify-between gap-4 md:gap-6 overflow-x-scroll scrollBar-none   transition-all" >
